...
wget -O /opt/zimbra-install/zimbra-zcs-8.8.15.tar.gz  https://files.zimbra.com/downloads/8.8.15_GA/zcs-8.8.15_GA_4179.UBUNTU20_64.20211118033954.tgz --no-check-certificate
